pipeline {
    ...
    environment {
        ...
        REPOSITORY_NAME  = 'uitpas-groepspas-frontend'
    }
    ...
    stages {
        ...
        stage('Setup and build') {
            ...
            stages {
                ...
                stage('Build') {
                    steps {
                        sh label: 'Build binaries', script: 'bundle exec rake uitpas-groepspas-frontend:build'
                    }
                }
                stage('Build artifact') {
                    steps {
                        sh label: 'Build artifact', script: "bundle exec rake uitpas-groepspas-frontend:build_artifact ARTIFACT_VERSION=${env.ARTIFACT_VERSION}"
